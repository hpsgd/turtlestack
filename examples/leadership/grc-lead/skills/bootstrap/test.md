...
- [ ] PASS: After bootstrap, `docs/governance/CLAUDE.md` still contains the sentinel line `USER-EDIT-SENTINEL-DO-NOT-STRIP` — the user-authored section was preserved verbatim
- [ ] PASS: After bootstrap, `docs/governance/CLAUDE.md` contains the safe-merge marker `<!-- Merged from grc-lead bootstrap v0.1.0 -->` — sections missing from the fixture were appended, not silently merged
- [ ] PASS: After bootstrap, `docs/governance/CLAUDE.md` contains the appended template sections — at minimum the "Risk Management (ISO 31000)" and "Compliance Frameworks" headings now appear alongside the preserved user content
...
- [ ] PASS: Output does not claim it overwrote or replaced `docs/governance/CLAUDE.md` — the language reflects merge, not replacement
