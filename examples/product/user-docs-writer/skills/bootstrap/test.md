...
- [ ] PASS: After bootstrap, `docs/content/_sections/user-docs-writer.md` still contains the sentinel line `USER-EDIT-SENTINEL-DO-NOT-STRIP` — the user-authored section was preserved verbatim
- [ ] PASS: After bootstrap, `docs/content/_sections/user-docs-writer.md` contains the safe-merge marker `<!-- Merged from user-docs-writer bootstrap v0.1.0 -->` — sections missing from the fixture were appended, not silently merged
- [ ] PASS: After bootstrap, `docs/content/_sections/user-docs-writer.md` contains the appended user-docs sections — at minimum the `## User Documentation` heading and the `### User Guide Conventions` heading now appear alongside the preserved user content
- [ ] PASS: After bootstrap, `docs/content/_sections/user-docs-writer.md` contains the `### KB Article Structure` section, which defines the KB article template
- [ ] PASS: After bootstrap, `docs/content/_sections/user-docs-writer.md` contains the `### Available User Docs Skills` section listing the four skill slash commands
...
- [ ] PASS: Output includes a manifest summary naming `docs/content/_sections/user-docs-writer.md`
